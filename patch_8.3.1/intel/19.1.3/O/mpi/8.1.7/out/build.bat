...
export ESMF_DIR=/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_patch_8.3.1/esmf
...
module list >& /lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_patch_8.3.1/module-build.log
cd /lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_patch_8.3.1/esmf
set -o pipefail
