...
#SBATCH -o /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpiuni_g_patch_8.3.1/build.bat_%j.o
#SBATCH -e /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpiuni_g_patch_8.3.1/build.bat_%j.e
#SBATCH --time=1:00:00
#SBATCH --cluster=c4
#SBATCH --qos=normal
#SBATCH --nodes=1
...
export ESMF_DIR=/lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpiuni_g_patch_8.3.1/esmf
...
export ESMF_MPIRUN=/lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpiuni_g_patch_8.3.1/esmf/src/Infrastructure/stubs/mpiuni/mpirun
module list >& /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpiuni_g_patch_8.3.1/module-build.log
cd /lustre/f2/dev/Mark.Potts/esmf-test/intel_2019.5_mpiuni_g_patch_8.3.1/esmf
set -o pipefail
