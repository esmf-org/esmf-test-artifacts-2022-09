...
export ESMF_DIR=/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/esmf
...
module list >& /lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/module-build.log
cd /lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_O_develop/esmf
set -o pipefail
