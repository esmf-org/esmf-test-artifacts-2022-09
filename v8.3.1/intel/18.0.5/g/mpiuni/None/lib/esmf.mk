...
ESMF_APPSDIR=/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf/apps/appsg/Linux.intel.64.mpiuni.default
ESMF_LIBSDIR=/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf/lib/libg/Linux.intel.64.mpiuni.default
...
ESMF_F90LINKPATHS=-L/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf/lib/libg/Linux.intel.64.mpiuni.default -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5//lib 
ESMF_F90ESMFLINKPATHS=-L/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf/lib/libg/Linux.intel.64.mpiuni.default
ESMF_F90LINKRPATHS=-Wl,-rpath,/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf/lib/libg/Linux.intel.64.mpiuni.default -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -Wl,-rpath,/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5//lib
ESMF_F90ESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf/lib/libg/Linux.intel.64.mpiuni.default
...
ESMF_CXXCOMPILEPATHS= -I/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf/src/include  -I/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/include -I/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf/src/Infrastructure/stubs/mpiuni -I/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf/src/prologue/yaml-cpp/include
ESMF_CXXCOMPILECPPFLAGS=-DESMF_NO_INTEGER_1_BYTE -DESMF_NO_INTEGER_2_BYTE -DESMF_VERSION_STRING_GIT='v8.3.1' -DESMF_MOAB=1 -DESMF_LAPACK=1 -DESMF_LAPACK_INTERNAL=1 -DESMF_NO_ACC_SOFTWARE_STACK=1 -DESMF_NETCDF=1 -DESMF_YAMLCPP=1 -DESMF_YAML=1 -DESMF_NO_OPENACC -DESMF_TESTEXHAUSTIVE -DESMF_BOPT_g -DESMF_TESTCOMPTUNNEL -DESMF_TESTWITHTHREADS -DSx86_64_small=1 -DESMF_OS_Linux=1 -DESMF_COMM=mpiuni -DESMF_DIR=/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf -D__SDIR__='' -DESMF_CXXSTD=11 -DESMF_MPIUNI

ESMF_CXXLINKOPTS=  -m64 -mcmodel=small -pthread -Wl,--no-as-needed  -qopenmp
ESMF_CXXLINKPATHS=-L/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf/lib/libg/Linux.intel.64.mpiuni.default -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5/lib -L/glade/u/apps/ch/opt/netcdf/4.6.3/intel/18.0.5//lib -L/glade/u/apps/opt/intel/2018u4/compilers_and_libraries_2018.5.274/linux/compiler/lib/intel64_lin/
ESMF_CXXESMFLINKPATHS=-L/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf/lib/libg/Linux.intel.64.mpiuni.default
...
ESMF_CXXESMFLINKRPATHS=-Wl,-rpath,/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf/lib/libg/Linux.intel.64.mpiuni.default
...
ESMF_TRACE_LDPRELOAD=/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf/lib/libg/Linux.intel.64.mpiuni.default/libesmftrace_preload.so
...
ESMF_INTERNAL_DIR=/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf
ESMF_INTERNAL_MPIRUN="/glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf/src/Infrastructure/stubs/mpiuni/mpirun"

#
# !!! The following options were used on this ESMF build !!!
#
# ESMF_DIR: /glade/scratch/dunlap/esmf-testing/intel_18.0.5_mpiuni_g_v8.3.1/esmf
# ESMF_OS: Linux
# ESMF_MACHINE: x86_64
# ESMF_ABI: 64
# ESMF_COMPILER: intel
