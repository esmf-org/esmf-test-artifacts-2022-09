...
export ESMF_DIR=/lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_g_fix_cygwin/esmf
...
module list >& /lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_g_fix_cygwin/module-build.log
cd /lfs/h1/emc/ptmp/Mark.Potts/intel_19.1.3_mpi_g_fix_cygwin/esmf
set -o pipefail
