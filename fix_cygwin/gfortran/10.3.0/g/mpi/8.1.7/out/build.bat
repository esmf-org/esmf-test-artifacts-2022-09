...
export ESMF_DIR=/lfs/h1/emc/ptmp/Mark.Potts/gfortran_10.3.0_mpi_g_fix_cygwin/esmf
...
module list >& /lfs/h1/emc/ptmp/Mark.Potts/gfortran_10.3.0_mpi_g_fix_cygwin/module-build.log
cd /lfs/h1/emc/ptmp/Mark.Potts/gfortran_10.3.0_mpi_g_fix_cygwin/esmf
set -o pipefail
